...
# Example usage
yolo_base_folder = "/home/uisee/MainDisk/DollyMonitor/train_check/dataset_0028/labels"
categories = ["car", "person"]

# Convert train set
train_coco_format = yolo_to_coco_for_subset(
    "/home/uisee/MainDisk/DollyMonitor/dolly_test_case/case_merge/imgs",
    "/home/uisee/MainDisk/DollyMonitor/train_check/dataset_0028/labels",
    categories
)
